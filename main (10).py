...
from optimization import path_func
...
def lambda_handler(event, context):
    ...
    if data:
        ...
        data = {}
    try:
        data_for_one_point=data.get('data')
        one_point_path = data_for_one_point.get("path")
        logging.info(f"Request Entered here")
        if one_point_path == "/get_optimization_progress_bar_data":
            result = get_optimization_progress_bar_data(data_for_one_point)
